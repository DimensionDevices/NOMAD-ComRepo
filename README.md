...
This repository holds some NOMAD Extensions (.ext) files and example hosted sites, games and apps (.com) files.

Some files are fully functional apps/games while others are more geared towards examples/tech demos. Some were created using LLM's as a quick way of proving many examples for developers to reference and utilise.

Details for how the .ext and .com files are created and managed are in the links below.
