...
function setStatus(e, t) {
    ...
    headerDot.className = `status-dot-header ${e}`;
...
function toggleStatus() {
    ...
    const t = headerDot.className.split(" ").find(t => e.includes(t)) || "online";
